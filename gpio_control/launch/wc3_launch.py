...
def generate_launch_description():
    ...
    gpio_controller_path = PathJoinSubstitution([FindPackageShare('gpio_control'), 'config', 'gpio_controller_omron_nxecc202_nxid5142_1_nxod5256.yaml'])
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare('gpio_control'), 'urdf', 'gpio_ros2_control_omron_nxecc202_nxid5142_1_nxod5256.xacro']
            ),
        ]
    )
